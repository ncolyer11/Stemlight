...
root.minsize(int((RSF**1.68)*620), int((RSF**1.3)*515))
...
dispenser_entry = tk.Entry(root, width=PAD, bg=col.bg_widget, fg=col.fg, font=main_font,
                           textvariable=dispenser_val)
dispenser_entry.grid(row=0, column=1, padx=PAD, pady=PAD)

dispenser_period_val = tk.DoubleVar(value=4)
dispenser_period_entry = tk.Entry(root, width=PAD, bg=col.bg_widget, fg=col.fg, font=main_font,
...
hat_period_entry = tk.Entry(root, width=PAD, bg=col.bg_widget, fg=col.fg, font=main_font,
                               textvariable=hat_period_val)
hat_period_entry.grid(row=2, column=1, padx=PAD, pady=PAD)

trunk_period_val = tk.DoubleVar(value=4)
trunk_period_entry = tk.Entry(root, width=PAD, bg=col.bg_widget, fg=col.fg, font=main_font,
                                 textvariable=trunk_period_val)
trunk_period_entry.grid(row=3, column=1, padx=PAD, pady=PAD)

trunk_height_val = tk.IntVar(value=1)
trunk_height_entry = tk.Entry(root, width=PAD, bg=col.bg_widget, fg=col.fg, font=main_font,
...
layer2_dispenser_entry = tk.Entry(root, width=PAD, bg=col.bg_widget, fg=col.fg, font=main_font,
...
trunk_start_entry = tk.Entry(root, width=PAD, bg=col.bg_widget, fg=col.fg, font=main_font,
...
infinite_dispenser_entry = tk.Entry(root, width=PAD, bg=col.bg_widget, fg=col.fg, font=main_font,
